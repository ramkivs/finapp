    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <KpiCard
          ...
          value={
            yieldMetric.status === 'NOT_CONFIGURED'
              ? 'Not configured'
              : `${yieldMetric.value}%`
          }
        ...
        <KpiCard
          ...
          value={
            goalMetric.status === 'NOT_CONFIGURED'
              ? 'Not configured'
              : goalMetric.value
          }
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
          <div className="bg-[#111F2D] border border-[#233548] p-4 rounded-xl">
            ...
            <p className="text-xs text-[#94A3B8] mt-1.5 leading-relaxed">
              Calculates trailing 12-month realized dividend income divided by
              the total valuation of registered brokerage and wealth investment accounts.
            </p>
          </div>

          <div className="bg-[#111F2D] border border-[#233548] p-4 rounded-xl">
            <h4 className="text-xs font-bold text-[#38BDF8]">
              Net Worth 1-Year CAGR
            </h4>
            <p className="text-xs text-[#94A3B8] mt-1.5 leading-relaxed">
              Computes annualized compound growth rate between canonical historical
              net worth snapshots: (EndingNetWorth / BeginningNetWorth) ^ (1 / years) - 1.
            </p>
          </div>

          <div className="bg-[#111F2D] border border-[#233548] p-4 rounded-xl">
            <h4 className="text-xs font-bold text-[#38BDF8]">
              Emergency Fund Goal Target
            </h4>
            <p className="text-xs text-[#94A3B8] mt-1.5 leading-relaxed">
              Evaluates target 6-month liquid cash runway against essential monthly
              debt service and recurring expenditure commitments.
            </p>
          </div>
        </div>
      </ChartCard>
